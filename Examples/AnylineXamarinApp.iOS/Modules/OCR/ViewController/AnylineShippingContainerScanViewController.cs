...
{    
    public sealed class AnylineShippingContainerScanViewController : UIViewController, IAnylineOCRModuleDelegate
    {
        ...
        public AnylineShippingContainerScanViewController(string name)
        {
            Title = name;
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            _ocrConfig.CustomCmdFilePath = NSBundle.MainBundle.PathForResource(@"Modules/OCR/container_scanner", @"ale");
            ...
            // We load the UI config for our container scanner view from a .json file.
            string configFile = NSBundle.MainBundle.PathForResource(@"Modules/OCR/shipping_container_config", @"json");
