...
{
    [Activity(Label = "Shipping Container", MainLauncher = false, Icon = "@drawable/ic_launcher", ScreenOrientation = Android.Content.PM.ScreenOrientation.Portrait, HardwareAccelerated = true)]
    public class ShippingContainerActivity : Activity, IAnylineOcrResultListener
    {
        public static string TAG = typeof(ShippingContainerActivity).Name;
        ...
        {            
            ...
            _scanView.SetConfigFromAsset("ShippingContainerViewConfig.json");
