...
namespace AnylineExamples.iOS
{
    ...
    /// </summary>
    public static class ObjectExtensions_old
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static Dictionary<string, object> CreatePropertyDictionary_old(this object obj)
        {
            int groupIndex = 0;
        ...
        public static void AddProperty_old(this Dictionary<string, object> dict, string name, object value)
        {
            if (value != null)
            {
